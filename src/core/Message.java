...
public class Message implements Comparable<Message> {
	...
	public Message(DTNHost from, DTNHost to, String id, int size) {
		...
		this.appID = null;
		this.reqs = new ArrayList<DTNHost>();
		
		Message.nextUniqueId++;
		addNodeOnPath(from);
	}
	
	public void setRequester(DTNHost req){
		this.reqs.add(req);
	}
	
	public void setRequesters(List<DTNHost> reqs){
		this.reqs.addAll(reqs);
	}
	
	public void removeRequester(DTNHost req){
		this.reqs.remove(req);
	}
	
	public List<DTNHost> getRequesters(){
		return this.reqs;
	}
	...
	protected void copyFrom(Message m) {
		...
		this.cid = m.cid;
		this.reqs = new ArrayList<DTNHost>(m.reqs);
